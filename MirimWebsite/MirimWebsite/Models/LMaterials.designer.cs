...
namespace MirimWebsite.Models
{
	...
	public partial class LMaterialsDataContext : System.Data.Linq.DataContext
	{
    ...
    partial void DeleteTStudy(TStudy instance);
		...
		public LMaterialsDataContext(string connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LMaterialsDataContext(System.Data.IDbConnection connection) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LMaterialsDataContext(string connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public LMaterialsDataContext(System.Data.IDbConnection connection, System.Data.Linq.Mapping.MappingSource mappingSource) : 
				base(connection, mappingSource)
		{
			OnCreated();
		}
		
		public System.Data.Linq.Table<TStudy> TStudy
		{
			get
			{
				return this.GetTable<TStudy>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.TStudy")]
	public partial class TStudy : INotifyPropertyChanging, INotifyPropertyChanged
	{
    ...
    partial void OntheAttachFileChanging(string value);
    partial void OntheAttachFileChanged();
    partial void OntheFileNameChanging(string value);
    partial void OntheFileNameChanged();
    ...
    partial void OntheDateChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_theAttachFile", DbType="NVarChar(256) NOT NULL", CanBeNull=false)]
		public string theAttachFile
		{
			get
			{
				return this._theAttachFile;
			}
			set
			{
				if ((this._theAttachFile != value))
				{
					this.OntheAttachFileChanging(value);
					this.SendPropertyChanging();
					this._theAttachFile = value;
					this.SendPropertyChanged("theAttachFile");
					this.OntheAttachFileChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_theFileName", DbType="NVarChar(256) NOT NULL", CanBeNull=false)]
		public string theFileName
		{
			get
			{
				return this._theFileName;
			}
			set
			{
				if ((this._theFileName != value))
				{
					this.OntheFileNameChanging(value);
					this.SendPropertyChanging();
					this._theFileName = value;
					this.SendPropertyChanged("theFileName");
					this.OntheFileNameChanged();
				}
			}
		}
